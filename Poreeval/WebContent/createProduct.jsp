	...
	<div class="container">
		<form action="CreateProductServlet" method="post">
			<div class="form-group">
				...
				<input type="text" class="form-control" placeholder="Namen hinzufügen" name="productname">
			</div>
			...
			<div class="form-group">
				<label>Notiz</label>
				<textarea class="form-control" placeholder="Notiz hinzufügen" name="note">
				</textarea>  <!--  Schließendes Tag nicht vergessen! :) -->
			</div>
